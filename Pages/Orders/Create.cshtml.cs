...
using static SneakerShopPostgreSQL.Pages.Carts.IndexModel;

namespace SneakerShopPostgreSQL.Pages.Orders
{
    public class CreateModel : PageModel
    {
        ...
        public async Task OnGetAsync()
        {
            if (_context.Carts != null)
            {
                ...
                {
                    User = await _context.User.FirstOrDefaultAsync(u => u.ID == int.Parse(HttpContext.Session.GetString("UserID")));
